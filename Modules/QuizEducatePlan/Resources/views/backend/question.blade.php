            ...
            <div class="col-md-4 text-right">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="javascript:void(0)" class="dropdown-item load-modal" data-url="{{ route('module.quiz_plan.question.get_modal_quiz_question', ['idsg' => $idsg, 'id' => $quiz->id]) }}">{{trans('backend.add_questionlib')}}</a>
                        <a href="javascript:void(0)" class="dropdown-item load-modal" data-url="{{ route('module.quiz.question.get_modal_question_category', ['idsg' => $idsg, 'id' => $quiz->id]) }}">{{trans('backend.add_random_question')}}</a>
                    </div>
                </div>
