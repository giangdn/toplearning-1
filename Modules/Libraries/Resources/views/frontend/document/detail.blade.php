                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="st_title"><i class="uil uil-apps"></i>
                                    ...
                                    <a href="{{ route('module.frontend.libraries.document',['id' => 0]) }}">@lang('app.document')</a> <i class="uil uil-angle-right"></i>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="col-12 my-2 pl-0">
                                        <h3 class="related_title">
                                            <span>Tài liệu cùng danh mục</span>
                                        </h3>
                                    </div>
                                    <div class="row mr-0 related_libraries">
                                        @foreach ($related_libraries as $related_library)
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="img-library">
                                                        <a href="{{ route('module.libraries.document.detail', ['id' => $related_library->id]) }}">
