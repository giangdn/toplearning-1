...
@section('page_title', trans('backend.quiz_type'))
...
@section('content')
    <div class="mb-4 forum-container">
        <h2 class="st_title">
            ...
            <span class="">{{ trans('backend.quiz_type') }}</span>
        </h2>
    </div>
    <div role="main">
        ...
        <div class="row">
            <div class="col-md-8">
                <form class="form-inline form-search mb-3" id="form-search">
                    <input type="text" name="search" value="" class="form-control" placeholder='{{trans("backend.enter_name_kind")}}'>
                    ...
                    <div class="modal-body" id="body_modal">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 control-label">
                                <label>Tên loại kỳ thi<span class="text-danger">*</span></label>
                            </div>
                            <div class="col-md-7">
