...
<div class="mb-4 forum-container">
    <h2 class="st_title"><i class="uil uil-apps"></i>
        ...
        <a href="{{ route('module.news_outside.category') }}">{{trans("backend.category_post")}}</a>
        <i class="uil uil-angle-right"></i>
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-right">
                <div class="btn-group act-btns">
                    ...
                    @endcan
                    <a href="{{ route('module.news_outside.category') }}" class="btn btn-warning"><i class="fa fa-times-circle"></i> {{ trans('backend.cancel') }}</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            {{-- <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <a href="javascript:void(0)" id="select-icon">{{ trans('backend.choose_picture') }}</a>
                                    <div id="icon-review" >
                                        @if($model->icon)
