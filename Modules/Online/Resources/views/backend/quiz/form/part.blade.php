    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <button type="button" class="btn btn-primary save-part"><i class="fa fa-save"></i> {{ trans('backend.save')}}</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <table class="tDefault table table-hover" id="table-part">
                <thead>
                    <tr>
                        ...
                        <th data-align="center" data-formatter="action_part_formatter">{{trans('backend.action')}}</th>
                    </tr>
                </thead>
            </table>
