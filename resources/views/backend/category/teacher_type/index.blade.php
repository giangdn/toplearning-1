...
@section('page_title', trans('backend.teacher_type'))
...
@section('content')
    <div class="mb-4 forum-container">
        <h2 class="st_title">
            ...
            <span class="">{{ trans('backend.teacher_type') }}</span>
        </h2>
    </div>
    <div role="main">
        <div class="row">
            <div class="col-md-8">
                <form class="form-inline form-search mb-3" id="form-search">
                    <input type="text" name="search" value="" class="form-control w-50" placeholder="{{ trans('backend.enter_code_name_lecture_type') }}">
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-sortable="true" data-field="code" data-width="10%">{{ trans('backend.teacher_type_code') }}</th>
                    <th data-sortable="true" data-field="code" data-formatter="name_formatter">{{ trans('backend.teacher_type_name') }}</th>
                    ...
                    <div class="modal-body" id="body_modal">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 control-label">
                                <label>Mã loại giảng viên<span class="text-danger">*</span></label>
                            </div>
                            <div class="col-md-7">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 control-label">
                                <label>Tên loại giảng viên<span class="text-danger">*</span></label>
                            </div>
                            <div class="col-md-7">
