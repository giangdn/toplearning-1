...
@section('breadcrumb')
    <div class="ibox-content forum-container">
        <h2 class="st_title"><i class="uil uil-apps"></i>
            ...
            <a href="{{ route('module.training_action.role') }}">@lang('backend.role')</a> <i class="uil uil-angle-right"></i>
...
@section('content')
    ...
    <div role="main">
        ...
        <form method="post" action="{{ route('module.training_action.role.save') }}" class="form-validate form-ajax " role="form" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-right">
                    <div class="btn-group act-btns">
                        ...
                        <a href="{{ route('module.training_action.role') }}" class="btn btn-warning"><i class="fa fa-times-circle"></i> @lang('backend.cancel')</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input name="name" type="text" class="form-control" value="{{ $model->name }}" required autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input name="name_en" type="text" class="form-control" value="{{ $model->name_en }}" autocomplete="off">
                                    </div>
                                </div>
