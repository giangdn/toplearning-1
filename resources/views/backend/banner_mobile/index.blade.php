...
@section('breadcrumb')
    <div class="ibox-content forum-container">
        <h2 class="st_title"><i class="uil uil-apps"></i>
            ...
            <span class="font-weight-bold">Banner login mobile</span>
        </h2>
    </div>
@endsection
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-right act-btns">
                <div class="pull-right">
                    ...
                    <div class="btn-group">
                        <a href="{{ route('backend.banner_login_mobile.create') }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i> {{ trans('backend.add_new') }}</a>
