...
@section('breadcrumb')
    <div class="ibox-content forum-container">
        <h2 class="st_title"><i class="uil uil-apps"></i>
            ...
            <span class="font-weight-bold">{{ trans('backend.field_category') }}</span>
        </h2>
    </div>
@endsection
...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-right act-btns">
                <div class="pull-right">
                    <div class="btn-group">
                        <a href="{{ route('module.training_action.field.create') }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i> @lang('backend.add_new')</a>
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('module.training_action.field.getdata') }}',
            remove_url: '{{ route('module.training_action.field.remove') }}',
        });
    </script>
@endsection
