...
@section('breadcrumb')
    <div class="ibox-content forum-container">
        <h2 class="st_title"><i class="uil uil-apps"></i>
            ...
            <a href="{{ route('backend.login_image') }}">Hình nền đăng nhập</a>
            <i class="uil uil-angle-right"></i>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-right">
                            <div class="btn-group act-btns">
                                ...
                                <a href="{{ route('backend.login_image') }}" class="btn btn-warning"><i class="fa fa-times-circle"></i> {{ trans('backend.cancel') }}</a>
                            </div>
                        </div>
                    </div>
