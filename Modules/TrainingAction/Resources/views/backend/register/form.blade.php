...
@section('breadcrumb')
    <div class="ibox-content forum-container">
        <h2 class="st_title"><i class="uil uil-apps"></i>
            ...
            <a href="{{ route('module.training_action.teachers') }}">@lang('backend.training_action_teachers')</a>
            <i class="uil uil-angle-right"></i>
...
@section('content')
    ...
    <div role="main">
        ...
        <form method="post" action="{{ route('module.training_action.teachers.save') }}" class="form-validate form-ajax " role="form" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-right">
                    <div class="btn-group act-btns">
                        ...
                        <a href="{{ route('module.training_action.teachers') }}" class="btn btn-warning"><i class="fa fa-times-circle"></i> @lang('backend.cancel')</a>
                    </div>
                </div>
            </div>
