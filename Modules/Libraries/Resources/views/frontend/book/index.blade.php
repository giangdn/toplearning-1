...
@section('content')
                            ...
                            <div class="col-md-12">
                                <div class="ibox-content forum-container">
                                    <h2 class="st_title"><i class="uil uil-apps"></i>
                                        ...
                                        <a href="{{route('module.frontend.libraries.book',['id' => 0])}}">
                                            <span class="font-weight-bold">@lang('app.book')</span>
                                        </a>
                                        @if (!empty($all_name_cate_book))
                                            @foreach($all_name_cate_book as $key => $name_cate_book)
                                                <i class="uil uil-angle-right"></i>
                                                <a href="{{route('module.frontend.libraries.book',['id' => $name_cate_book->id])}}">
                                                    <span class="font-weight-bold">{{ $name_cate_book->name }}</span>
                                                </a>
                                            @endforeach
                                        @endif
                                    </h2>
                            ...
                            <div class="col-md-12">
                                <div class="row search-course pb-2">
                                    <div class="col-md-12 mt-3 form-inline">
                                        <form action="{{route('module.frontend.libraries.book',['id' => 0])}}" method="post" class="form-inline w-100" id="form-search" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div class="col-12 col-md-3 pl-0">
                                                <select name="search_cate" class="form-control search_type w-100"> 
                                                    <option value="" selected disabled>Danh mục</option>
                                                    @foreach ($get_category_books as $item)
                                            ...
                                            <div class="col-12 col-md-2 pl-0">
                                                <div class="libraries_name">
                                                    <input type="text" name="search" id="search" value="" class="form-control search_text w-100" placeholder="Tên sách" style="width: 230px">
                                            ...
                                            <div class="col-12 col-md-2 pl-0">
                                                <select name="type" id="type" class="form-control search_type mr-1 w-100"> 
    ...
    <script>
        ...
        function load_more(page){
            $.ajax({
                url: '{{ route('module.frontend.libraries.book',['id' => 0]) }}' + "?page=" + page,
                type: "get",
                datatype: "html",
                beforeSend: function() 
                {
