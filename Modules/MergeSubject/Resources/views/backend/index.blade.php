        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right act-btns">
                <div class="pull-right">
                    <div class="btn-group" >
                        <button id="importMergesubject" type="button" class="btn btn-secondary" >
                            <i class="fa fa-upload"> </i> Import
                        </button>
                        <a class="btn btn-secondary" href="{{ download_template('mau_import_gop_chuyen_de.xlsx') }}"><i class="fa fa-download"> Download file mẫu </i></a>
                    </div>
                    <div class="btn-group">
                    ...
                    <div class="btn-group">
                        @can('mergesubject-create')
                            <a href="{{ route('module.mergesubject.create') }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i> {{trans('backend.add_new')}}</a>
                        @endcan
                    ...
                    @can('merge-subject-watch-log')
                        <a class="btn btn-success" href="{{route('module.mergesubject.logs')}}"><i class="fa fa-check-circle"></i> {{trans('backend.view_logs')}}</a>
                    @endcan
                </div>
            </div>
        </div>
