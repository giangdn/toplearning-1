        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-field="forum" data-align="center" data-width="10%" data-formatter="addForums">{{trans('backend.posts')}}</th>
                    <th data-field="status" data-width="10%" data-formatter="status_formatter" data-align="center" >{{ trans('backend.status') }}</th>
                    <th data-field="action" data-width="5%" data-align="center" data-formatter="action_formatter">{{ trans('backend.approve') }}</th>
                </tr>
            </thead>
        </table>
    </div>
