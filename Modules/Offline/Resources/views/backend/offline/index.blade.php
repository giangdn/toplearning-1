    ...
    <div class="row">
                ...
                <div class="form-row align-items-center">
                    <div class="col-sm-2 my-1">
                        <input type="text"
                               ...
                               class="form-control"
                               autocomplete="off"
                               placeholder="{{ trans('backend.code_name_course') }}">
                    </div>
                    ...
                    <div class="col-sm-2 my-1">
                        <select name="training_program_id"
                                ...
                                data-placeholder="{{ trans('backend.training_program') }}">
                        </select>
                    </div>
                    ...
                    <div class="col-sm-2 my-1">
                        <select name="level_subject_id"
                                ...
                                data-placeholder="Mảng nghiệp vụ">
                        </select>
                    </div>
                    ...
                    <div class="col-sm-2 my-1">
                        <input name="start_date"
                               ...
                               placeholder="{{ trans('backend.start_date') }}"
                               autocomplete="off">
                    </div>
                    ...
                    <div class="col-sm-2 my-1">
                        <input name="end_date"
                               type="text"
                               class="datepicker form-control"
                               placeholder="{{ trans('backend.end_date') }}"
                               autocomplete="off">
                    </div>

                    <button type="submit"
                            class="btn btn-primary ml-2"><i
                           class="fa fa-search"></i>&nbsp;{{ trans('backend.search') }}</button>
                </div>
            </form>
        </div>
        <div class="col-md-12 text-right act-btns">
            <div class="pull-right">
                ...
                <div class="btn-group">
                    <button class="btn btn-success approved" data-model="el_offline_course"
                            data-status="1">
                        <i class="fa fa-check-circle"></i> {{ trans('backend.approve') }}
                    </button>
                    <button class="btn btn-danger approved" data-model="el_offline_course"
                            data-status="0">
                ...
                <div class="btn-group">
                    ...
                    @can('offline-course-create')
                        <a href="{{ route('module.offline.create') }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i>
                            {{ trans('backend.add_new') }}
                        </a>
                    @endcan
                    @can('offline-course-delete')
                    <button class="btn btn-danger"
                            id="delete-item"><i class="fa fa-trash"></i>
                        {{ trans('backend.delete') }}</button>
                    @endcan
                </div>
            </div>
        </div>
    ...
    <table class="tDefault table table-hover bootstrap-table">
        <thead>
            <tr>
                ...
                <th data-align="center" data-formatter="isopen_formatter" data-width="3%">{{ trans('backend.open_off') }}</th>
                <th data-formatter="name_formatter">{{ trans('backend.course_name') }}</th>
                ...
                <th data-field="register_deadline" data-align="center" data-width="5%">{{ trans('backend.register_deadline') }}</th>
...
{{--                <th data-align="center" data-formatter="created_by_formatter">{{ trans('backend.code_user_create') }}</th>--}}
                ...
                <th data-field="lock_course" data-align="center" data-formatter="lock_formatter" data-width="5%">Khóa</th>
...
<script type="text/javascript">
    ...
    function approved_formatter(value, row, index) {
        return value? `<a href="javascript:void(0)" data-id="${row.id}" data-model="el_offline_course" class="text-success font-weight-bold load-modal-approved-step">${value}</a>`:'-';
    }
