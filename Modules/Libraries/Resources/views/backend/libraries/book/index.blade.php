        ...
        <div class="row">
            <div class="col-md-7 form-inline">
                <form class="form-inline w-100 form-search mb-3" id="form-search">
                    <input type="text" name="search" class="form-control w-50" placeholder="--Tìm kiếm tên sách/tác giả--">
                    <div class="w-25">
            ...
            <div class="col-md-5 text-right act-btns">
                <div class="pull-right">
                    ...
                    @endcan
                    <div class="btn-group">
                        <a class="btn btn-info" href="{{ route('module.libraries.book.export') }}"><i class="fa fa-download"></i> Export</a>
                        @can('libraries-book-create')
                            <a href="{{ route('module.libraries.book.create') }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i> {{ trans('backend.add_new') }}</a>
                        @endcan
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-field="category_name">{{trans('backend.category_book')}}</th>
