    ...
    <div class="row">
        ...
        <div class="col-md-4 text-right">
            <div class="btn-group act-btns">
                ...
                @endcanany
                <a href="{{ route('module.libraries.document') }}" class="btn btn-warning"><i class="fa fa-times-circle"></i> {{ trans('backend.cancel') }}</a>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <select name="category_id" id="category_id" class="form-control select2"
                            data-placeholder="--Chọn danh mục tài liệu--" required>
                        <option value=""></option>
            ...
            <div class="form-group row">
                <div class="col-sm-3 control-label">
                    <label for="name_author">Nguồn soạn thảo <span class="text-danger">*</span></label>
                </div>
                <div class="col-md-6">
                    <input name="name_author" type="text" class="form-control" placeholder="-- Tên Nguồn soạn thảo --" value="{{ $model->name_author }}" required>
                </div>
            </div>
