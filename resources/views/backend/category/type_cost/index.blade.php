...
@section('page_title', trans('backend.type_cost'))
...
@section('content')
    <div class="mb-4 forum-container">
        <h2 class="st_title">
            ...
            <span class="">{{ trans('backend.type_cost') }}</span>
        </h2>
    </div>
    <div role="main">
        <div class="row">
            <div class="col-md-8">
                <form class="form-inline form-search mb-3" id="form-search">
                    <input type="text" name="search" value="" class="form-control" placeholder="Nhập mã/tên">
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-sortable="true" data-field="code">Mã loại chi phí đào tạo</th>
                    <th data-sortable="true" data-field="name" data-formatter="name_formatter">Tên loại chi phí đào tạo</th>
                </tr>
            </thead>
        </table>
    </div>
