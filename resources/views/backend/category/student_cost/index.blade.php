...
@section('page_title', trans('backend.student_cost'))
...
@section('content')
    <div class="mb-4 forum-container">
        <h2 class="st_title">
            ...
            <span class="">{{ trans('backend.student_cost') }}</span>
        </h2>
    </div>
    <div role="main">
        <div class="row">
            <div class="col-md-8">
                <form class="form-inline form-search mb-3" id="form-search">
                    <input type="text" name="search" value="" class="form-control w-25" placeholder="Nhập tên chi phí học viên">
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-sortable="true" data-field="name" data-formatter="name_formatter">{{ trans('backend.student_cost_name') }}</th>
                    ...
                    <div class="modal-body" id="body_modal">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 control-label">
                                <label>Tên chi phí học viên<span class="text-danger">*</span></label>
                            </div>
                            <div class="col-md-7">
