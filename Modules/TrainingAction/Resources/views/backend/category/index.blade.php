...
@section('breadcrumb')
    <div class="ibox-content forum-container">
        <h2 class="st_title"><i class="uil uil-apps"></i>
            ...
            <span class="font-weight-bold">{{ trans('backend.training_action_category') }}</span>
        </h2>
    </div>
@endsection
...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-right act-btns">
                <div class="pull-right">
                    <div class="btn-group">
                        <a href="{{ route('module.training_action.category.create') }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i> @lang('backend.add_new')</a>
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-sortable="true" data-field="options" data-width="15%" data-align="center" data-formatter="options_formatter">@lang('backend.options')</th>
                </tr>
            </thead>
        </table>
    </div>
    ...
    <script type="text/javascript">
        ...
        function options_formatter(value, row, index) {
            let str = '<a href="'+ row.teachers_url +'">@lang('backend.teacher')</a>';
            str += '<a class="ml-2" href="'+ row.students_url +'">@lang('backend.student')</a>';
            return str;
        }
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('module.training_action.category.getdata') }}',
            remove_url: '{{ route('module.training_action.category.remove') }}',
        });
    </script>
@endsection
