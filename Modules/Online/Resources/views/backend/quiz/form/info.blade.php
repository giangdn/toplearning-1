        ...
        <div class="col-md-3">
            <div class="form-group text-right">
                <div class="btn-group act-btns">
                    ...
                    @endif
                        <a href="{{ route('module.online.quiz', ['course_id' => $course_id]) }}" class="btn btn-warning"><i class="fa fa-times-circle"></i> {{ trans('backend.cancel') }}</a>
                </div>
            </div>
            <p></p>
            ...
            <div class="form-group">
                ...
                <select name="quiz_type" id="quiz_type" class="form-control select2" data-placeholder="{{trans('backend.choose_form')}}" required>
                    <option value="1" selected> {{trans('backend.online')}}</option>
                </select>
            </div>
