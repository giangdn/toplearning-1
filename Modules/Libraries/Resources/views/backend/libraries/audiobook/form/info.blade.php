        ...
        <div class="col-md-4 text-right">
            <div class="btn-group act-btns">
                @canany(['libraries-audiobook-create', 'libraries-audiobook-edit'])
                    <a style="cursor: pointer" id="add_more_video" onclick="addMoreVideos()" class="btn btn-primary"><i class="fa fa-plus-circle"></i> &nbsp;Thêm sách nói</a>
                    <button type="submit" class="btn btn-primary" data-must-checked="false"><i class="fa fa-save"></i> &nbsp;{{ trans('backend.save') }}</button>
                @endcanany
                <a href="{{ route('module.libraries.audiobook') }}" class="btn btn-warning"><i class="fa fa-times-circle"></i> {{ trans('backend.cancel') }}</a>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="form-group row">
                <div class="col-sm-3 control-label">
                    <label for="name">Sách nói <span class="text-danger">*</span></label>
                </div>
                <div class="col-md-6">
            ...
            <div class="form-group row">
                <div class="col-sm-3 control-label">
                    <label for="category_id">Danh mục sách nói <span class="text-danger">*</span></label>
                </div>
                <div class="col-md-6">
            ...
            <div id="new_video">
                @if (isset($audiobooks))
                    ...
                    <div class="form-group row" id="name-video-{{$audiobook->id}}">
                        <div class="col-sm-3 control-label">
                            <label for="name_audiobooks">Tên sách nói <span class="text-danger">*</span></label>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row" id="{{$audiobook->id}}">
                        ...
                        <div class="col-sm-2 control-label">
                            <a style="cursor: pointer" id="close_add_videos" onclick="closeAddVideos({{$audiobook->id}})" class="btn btn-primary">Xóa</a>
                        </div>
                    </div>
                    @endforeach
                @endif
