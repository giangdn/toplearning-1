...
@section('page_title', @trans('backend.training_object') )
...
@section('content')
    <div class="mb-4 forum-container">
        <h2 class="st_title">
            ...
            <span class="">{{ trans('backend.training_object') }}</span>
        </h2>
    </div>
    <div role="main">
        @if(isset($errors))
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-right act-btns">
                <div class="pull-right">
                    @can('category-training_object-edit')
                        <div class="btn-group"> 
                    ...
                    @endcan
                    <div class="btn-group">
                        @can('category-training_object-create')
                        ...
                        @endcan
                        @can('category-training_object-delete')
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-sortable="true" data-field="code" data-width="10%">{{ trans('backend.training_object_code') }}</th>
                    <th data-sortable="true" data-field="name" data-formatter="name_formatter">{{ trans('backend.training_object_name') }}</th>
                    ...
                    <div class="modal-body" id="body_modal">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 control-label">
                                <label>Mã đối tượng đào tạo<span class="text-danger">*</span></label>
                            </div>
                            <div class="col-md-7">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 control-label">
                                <label>Tên đối tượng đào tạo<span class="text-danger">*</span></label>
                            </div>
                            <div class="col-md-7">
