<table class="tDefault table table-hover bootstrap-table" id="tab-history">
    <thead>
    <tr>
        ...
        <th data-field="tab_edit">Tab {{trans('backend.edit')}}</th>
        <th data-field="ip_address">{{trans('backend.address')}} ip</th>
