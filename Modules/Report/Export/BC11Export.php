...
class BC11Export implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize,  WithEvents, WithStartRow, WithDrawings
{
    ...
    public function map($report): array
    {
        ...
        $answer_query = \DB::query()
            ->from('el_rating_question_answer')
    ...
    public function headings(): array
    {
        ...
        return [
            ...
            ['Ngày bắt đầu', '', get_date($course->start_date)],
            ['Ngày kết thúc', '', get_date($course->end_date)],
            ['Đơn vị đào tạo', '', $this->course_type == 2 ? $course->training_unit : ''],
            ['Giảng viên', '',  $this->course_type == 2 ? implode('; ', $teachers) : ''],
