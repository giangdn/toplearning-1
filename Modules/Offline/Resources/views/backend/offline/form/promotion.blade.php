    ...
    <div class="col-md-12">
        <div class="text-right">
            @if(\Modules\Online\Entities\OnlinePermission::saveCourse($model) && $model->lock_course == 0)
                <button id="delete-setting-landmarks" class="btn btn-danger"><i class="fa fa-trash"></i> {{ trans('backend.delete') }}</button>
            @endif
        </div>
        <p></p>
        <table class="tDefault table table-hover bootstrap-table" id="table-setting-landmarks">
            <thead>
            <tr>
...
<div class="row promotion-table-attendance box-hidden">
    <div class="col-md-12">
        <div class="text-right">
            @if(\Modules\Online\Entities\OnlinePermission::saveCourse($model) && $model->lock_course == 0)
                <button id="delete-setting-attendance" class="btn btn-danger"><i class="fa fa-trash"></i> {{ trans('backend.delete') }}</button>
            @endif
        </div>
        <p></p>
        <table class="tDefault table table-hover bootstrap-table" id="table-setting-attendance">
            <thead>
            <tr>
                <th data-field="state" data-checkbox="true"></th>
                <th data-align="center" data-width="3%" data-formatter="stt_formatter">STT</th>
