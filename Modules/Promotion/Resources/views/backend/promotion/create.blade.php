...
@section('content')
    <div class="mb-4 forum-container">
        <h2 class="st_title"><i class="uil uil-apps"></i>
            ...
            <a href="{{ route('module.promotion') }}">{{trans('backend.accumulate_bonus_points')}}</a>
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <span>
                                            <input name="period" type="text" placeholder="{{ trans('backend.end_date') }}" class="form-control d-inline-block w-25" autocomplete="off" value="" id="datetimepicker">
                                        </span>
                                    </div>
                                </div>
                                <div class="form-group row">
