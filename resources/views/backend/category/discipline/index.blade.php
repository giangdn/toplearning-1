...
@section('page_title', @trans('backend.disciplinet'))
...
@section('content')
    <div class="mb-4 forum-container">
        <h2 class="st_title">
            ...
            <span class="">{{ trans('backend.disciplinet') }}</span>
        </h2>
    </div>
    <div role="main">
        @if(isset($errors))
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-sortable="true" data-field="name" data-formatter="name_formatter">{{ trans('backend.discipline_name') }}</th>
                    ...
                    <div class="modal-body" id="body_modal">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 control-label">
                                <label>Mã vi phạm<span class="text-danger">*</span></label>
                            </div>
                            <div class="col-md-7">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 control-label">
                                <label>Tên vi phạm<span class="text-danger">*</span></label>
                            </div>
                            <div class="col-md-7">
