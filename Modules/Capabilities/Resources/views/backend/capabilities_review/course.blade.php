...
@section('breadcrumb')
    <div class="ibox-content forum-container">
        <h2 class="st_title"><i class="uil uil-apps"></i>
            ...
            {{trans('backend.student')}}: {{ $user->lastname .' '. $user->firstname }}
        </h2>
    </div>
@endsection
        ...
        <div class="tPanel">
            <div class="tab-content">
                <div id="base" class="tab-pane active">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="text-center pb-2">CHƯƠNG TRÌNH ĐÀO TẠO THEO KHUNG NĂNG LỰC</h3>
                            ...
                            <div class="form-group row">
                                <label class="control-label col-sm-3"><b>{{ trans('backend.unit') }}</b></label>
                                <div class="col-sm-8">
                                    @if(isset($unit->name)) {{ $unit->name }} @endif
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-sm-3"><b>{{ trans('backend.title') }}</b></label>
                                <div class="col-sm-8">
                                    @if(isset($title->name)) {{ $title->name }} @endif
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-sm-3"><b>{{trans('backend.status')}}</b></label>
                                <div class="col-sm-8">
                                    @if($percent == 0)
