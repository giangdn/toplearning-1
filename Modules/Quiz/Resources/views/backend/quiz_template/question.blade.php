...
<div class="mb-4 forum-container">
    <h2 class="st_title"><i class="uil uil-apps"></i>
        ...
        <a href="{{ route('module.quiz_template.edit', ['id' => $quiz->id]) }}">{{ $quiz->name }}</a>
        <i class="uil uil-angle-right"></i>
            ...
            <div class="col-md-4 text-right">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="javascript:void(0)" class="dropdown-item load-modal" data-url="{{ route('module.quiz_template.question.get_modal_quiz_template_question', ['id' => $quiz->id]) }}">{{trans('backend.add_questionlib')}}</a>
                        <a href="javascript:void(0)" class="dropdown-item load-modal" data-url="{{ route('module.quiz_template.question.get_modal_question_category', ['id' => $quiz->id]) }}">{{trans('backend.add_random_question')}}</a>
                    </div>
                </div>
