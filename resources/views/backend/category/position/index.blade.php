...
@section('page_title', trans('backend.position'))
...
@section('content')
    <div class="mb-4 forum-container">
        <h2 class="st_title">
            ...
            <span class="">{{ trans('backend.position') }}</span>
        </h2>
    </div>
    <div role="main">
        @if(isset($errors))
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-sortable="true" data-field="name" data-formatter="name_formatter">{{ trans('backend.position_name') }}</th>
