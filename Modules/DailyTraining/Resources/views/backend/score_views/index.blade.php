...
@section('page_title', trans('backend.setting_views'))
...
@section('content')
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('module.daily_training.score_views.getdata') }}',
            remove_url: '{{ route('module.daily_training.score_views.remove') }}'
        });
        ...
        function edit(id){
            ...
            $.ajax({
                url: "{{ route('module.daily_training.score_views.edit') }}",
                type: 'post',
                data: {
                    id: id,
                }
        ...
        function save(event) {
            ...
            $.ajax({
                url: "{{ route('module.daily_training.score_views.save') }}",
                type: 'post',
                data: {
                    'from': from,
                    'id': id,
