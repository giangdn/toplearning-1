...
@section('page_title', @trans('backend.absent_reason'))
...
@section('content')
    <div class="mb-4 forum-container">
        <h2 class="st_title">
            ...
            <span class="">{{ trans('backend.absent_reason') }}</span>
        </h2>
    </div>
    <div role="main">
        @if(isset($errors))
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-sortable="true" data-field="name" data-formatter="name_formatter">{{ trans('backend.absent_reason_name') }}</th>
