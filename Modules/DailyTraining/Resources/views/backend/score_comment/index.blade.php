...
@section('page_title', trans('backend.setting_comment'))
...
@section('content')
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('module.daily_training.score_comment.getdata') }}',
            remove_url: '{{ route('module.daily_training.score_comment.remove') }}'
        });
        ...
        function edit(id){
            ...
            $.ajax({
                url: "{{ route('module.daily_training.score_comment.edit') }}",
                type: 'post',
                data: {
                    id: id,
                }
        ...
        function save(event) {
            ...
            $.ajax({
                url: "{{ route('module.daily_training.score_comment.save') }}",
                type: 'post',
                data: {
                    'from': from,
                    'id': id,
