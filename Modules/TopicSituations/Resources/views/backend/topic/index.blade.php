        ...
        <div class="row">
            <div class="col-md-6">
                <form class="form-inline form-search mb-3" id="form-search">
                    <input type="text" name="search" value="" class="form-control " placeholder='Nhập Tên/Mã'>
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-field="status" data-align="center" data-formatter="status_formatter" data-width="5%">Trạng thái</th>
                    <th data-field="image" data-align="center" data-formatter="image_formatter" data-width="15%">Hình ảnh</th>
                    <th data-sortable="true" data-field="name" data-formatter="name_formatter">Tên Xử lý tình huống</th>
                    <th data-field="code">Mã Xử lý tình huống</th>
                    <th data-field="image" data-align="center" data-formatter="situation_formatter" data-width="15%">Thảo luận Tình huống</th>
                </tr>
            </thead>
        </table>
    </div>
