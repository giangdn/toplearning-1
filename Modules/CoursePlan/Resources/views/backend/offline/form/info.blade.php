    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <select name="title_join_id[]" id="title_join_id" class="form-control select2" data-placeholder="-- Chức danh tham gia --" multiple required>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <select name="training_object_id[]" id="training_object_id" class="form-control select2" multiple data-placeholder="-- Nhóm đối tượng tham gia --">
            ...
            <div class="form-group row">
                <div class="col-sm-3 control-label">
                    <label>Loại giảng viên <span class="text-danger">*</span></label>
                </div>
                <div class="col-md-9">
                    <select name="teacher_type_id" id="teacher_type_id" class="form-control load-teacher-type" data-placeholder="-- Loại giảng viên --" required>
            ...
            <div class="form-group row">
                <div class="col-sm-3 control-label">
                    <label>Thời gian đào tạo</label><span class="text-danger"> * </span>
                </div>
                <div class="col-md-9">
            ...
            <div class="row row-acts-btn">
                <div class="col-sm-12">
                    <div class="btn-group act-btns">
                        ...
                        @endcan
                        <a href="{{ route('module.course_plan.management') }}" class="btn btn-warning"><i class="fa fa-times-circle"></i> {{ trans('backend.cancel') }}</a>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label>{{trans('backend.picture')}} (400 x 400)</label>
                <div>
